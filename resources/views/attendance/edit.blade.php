                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('device_id') is-invalid @enderror" id="device_id" name="device_id">
                                        ...
                                        @foreach($devices as $device)
                                            <option value="{{ $device->id }}" {{ old('device_id', $attendance->device_id) == $device->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('check_in_time') is-invalid @enderror" id="check_in_time" name="check_in_time" value="{{ old('check_in_time', $attendance->check_in_time ? $attendance->check_in_time->format('Y-m-d\\TH:i') : '') }}" required>
                                    @error('check_in_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('check_out_time') is-invalid @enderror" id="check_out_time" name="check_out_time" value="{{ old('check_out_time', $attendance->check_out_time ? $attendance->check_out_time->format('Y-m-d\\TH:i') : '') }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('attendance_type') is-invalid @enderror" id="attendance_type" name="attendance_type" required>
                                        <option value="office" {{ old('attendance_type', $attendance->attendance_type) == 'office' ? 'selected' : '' }}>Kantor</option>
                                        <option value="remote" {{ old('attendance_type', $attendance->attendance_type) == 'remote' ? 'selected' : '' }}>Remote</option>
                                    </select>

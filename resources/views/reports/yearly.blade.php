        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
                    <h5 class="card-title mb-0">Laporan Tahunan - {{ $year }}</h5>
                    <div class="d-flex gap-2">
                        <a href="{{ route('reports.export.pdf') }}?year={{ $year }}" class="btn btn-danger">
                            ...
                            <tbody>
                                ...
                                @forelse($groupedAttendances as $employeeId => $employeeAttendances)
                                    @php
                                        ...
                                        $avgHours = 12 > 0 ? round($totalHours / 12, 2) : 0; // Average per month
                                    @endphp
                                    <tr>
                                        <td>{{ $employee->name }}</td>

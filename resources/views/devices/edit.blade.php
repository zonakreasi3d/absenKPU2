        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Edit Mesin Absensi</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('device_location') is-invalid @enderror" id="device_location" name="device_location" value="{{ old('device_location', $device->device_location) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('device_type') is-invalid @enderror" id="device_type" name="device_type" required>
                                        ...
                                        <option value="handkey" {{ old('device_type', $device->device_type) == 'handkey' ? 'selected' : '' }}>Handkey</option>
                                        <option value="android" {{ old('device_type', $device->device_type) == 'android' ? 'selected' : '' }}>Android</option>
                                    </select>
                                    @error('device_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                        ...
                                        <option value="inactive" {{ old('status', $device->status) == 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                                        <option value="maintenance" {{ old('status', $device->status) == 'maintenance' ? 'selected' : '' }}>Perawatan</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
